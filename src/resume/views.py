...
def Resume(request):
    return render(request, "views/Resume.html")


def Signup(request):
    return render(request, "views/sign_up.html")
...
def upload_resume(request):
    ...
    return render(request, "views/Resume.html", context)
...
def list_resumes(request):
    ...
    return render(request, "views/resume_list.html", context)
